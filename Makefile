...
help:
	...
	@echo "  dgm_quick         - Quick DGM benchmark with mock models"
	@echo "  dgm_live          - DGM benchmark with live API models"
	@echo "  dgm_test_integration - Test DGM integration components"
	@echo "  dgm_cleanup       - Clean DGM containers and artifacts"
